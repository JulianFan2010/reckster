...
function startGame(round) {
    ...
    while (attemptCount <= round && status === "in-progress") {
        let currentGuess = prompt("Enter a five letter word: ");
    ...
    if (status === "success") {
        ...
        alert(`The word is ${answer} What is wrong with you, it's such an easy word. I get it correct in my first try!!!!`);
    }
}
